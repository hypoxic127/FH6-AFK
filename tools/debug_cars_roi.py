...
cv2.putText(annotated, "Cars ROI (9-13%, 6-14%)", (x1, y1 - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
...
print("已保存: debug_cars_roi_annotated.png + debug_cars_roi_crop.png")
